...
/*! parsely-js-api - v2.1.0 - 2023-11-16
...
window.PARSELY = window.PARSELY || {},
    ...
    function(e, t) {
        ...
        var L = /^key/,
            O = /^(?:mouse|pointer|contextmenu)|click/,
        ...
        y.event = {
            ...
            "add": function(e, t, n, i, o) {
                ...
                if (h) {
                    for (n.handler && (n = (u = n).handler, o = u.selector), n.guid || (n.guid = y.guid++), (a = h.events) || (a = h.events = {}), (c = h.handle) || ((c = h.handle = function(e) {
                            return _typeof(y) === R || e && y.event.triggered === e.type ? undefined : y.event.dispatch.apply(c.elem, arguments)
            ...
            "fix": function(e) {
                ...
                var t, n, i, o = e.type,
                    r = e,
                    a = this.fixHooks[o];
                for (a || (this.fixHooks[o] = a = O.test(o) ? this.mouseHooks : L.test(o) ? this.keyHooks : {}), i = a.props ? this.props.concat(a.props) : this.props, e = new y.Event(r), t = i.length; t--;) e[n = i[t]] = r[n];
    ...
    function() {
        ...
        PARSELY.Pixel = n.extend({
            ...
            "sendEvent": function(n, i) {
                o.log("beaconing to endpoint: " + this.remoteEndpoint), n.u = i, (new Image).src = this.buildEventRequestUrl(n), t.isFunction(e.onBeacon) && e.onBeacon(n)
            },
            "requestFetch": function(n, i) {
                return o.log("fetching endpoint: " + this.remoteEndpoint), "undefined" != typeof c.fetch && (n.u = i, fetch(this.buildEventRequestUrl(n), {
                    "method": "GET",
                    "mode": "no-cors",
                    "keepalive": !0
                })["catch"](function(e) {
    ...
    function() {
        ...
        PARSELY.Beacon = i.extend({
            ...
            "trackPageView": function(i, s) {
                void 0 !== i && "undefined" != typeof i.action && "pageview" !== i.action || e.initNewPage(!1);
                var u = {
                    "title": a.title,
                    "date": (new Date).toString(),
                    "action": "pageview",
                ...
                e.hasOwnProperty("metadata") && (u.hasOwnProperty("metadata") ? u.metadata = o.stringify(t.extend(u.metadata, e.metadata.get())) : u.metadata = o.stringify(e.metadata.get()));
                var d = r.getJSON("_parsely_slot_click");
                d && (r.expire("_parsely_slot_click"), n.log("Valid slot click found"), u.sl_xp = d.xpath, u.sl_x = d.x, u.sl_y = d.y, u.sl_h = d.href, d.url !== u.urlref && n.log("urlref overridden by slot data as " + d.url), u.urlref = d.url), i && t.extend(u, i), this.pixel.beacon(u, s)
            },
    ...
    function() {
        ...
        for (var n = ["Lead Capture", "Link Click", "Newsletter Signup", "Subscription", "Purchase", "Custom"], i = function(e, t) {
                var n = {
                    "action": "conversion",
                    "data": {
                        "_conversion_type": e
        ...
        if (document.querySelector && document.querySelectorAll) {
            var u = function(e) {
                ...
                c = function(e, t) {
                    ...
                    return n.href = t, e.host === n.host && (0 === e.pathname.indexOf(n.pathname) && (!(n.search.length > 0) || d(e.search, n.search)))
                };
            e.conversions.ConversionFromConfigs = t.extend({
                "init": function(t) {
                    var n, i = this;
                    this.results = [], this.config = t, "function" == typeof(n = e.conversions[r(i.config.type)]) ? (this.conversionAction = function(t) {
                        u(i.config.conditions, i.config.pianoConditions, t) ? e.config.customizations && !0 === e.config.customizations.debug ? console.log('Debug: Conversion event would have been sent with type "'.concat(i.config.type, '" and label "').concat(i.config.label || i.config.type, '".')) : n(i.config.label) : e.console.log("Conversion callback triggered but conditions not satisfied: ".concat(i.config.conditions))
                        ...
                        if (Object.prototype.hasOwnProperty.call(i.config, "allowedUrls")) {
                            for (var t = e.util.getWindow().location, n = 0; n < i.config.allowedUrls.length; n++)
                                if (c(t, i.config.allowedUrls[n])) return !0;
                            return !1
                        }
                        return !0
