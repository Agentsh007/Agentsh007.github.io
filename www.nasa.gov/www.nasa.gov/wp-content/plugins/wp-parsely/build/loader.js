            ...
            void 0 !== window.wpParselySiteId && (null === (t = window.wpParselyHooks) || void 0 === t || t.addAction("wpParselyOnLoad", "wpParsely", (function() {
                ...
                return e = this, t = void 0, a = function() {
                    ...
                    return function(n, o) {
                        ...
                        return e = null === (o = null === (n = window.PARSELY) || void 0 === n ? void 0 : n.config) || void 0 === o ? void 0 : o.parsely_site_uuid, window.wpParselySiteId && e ? (t = "".concat("https://api.parsely.com/v2", "/profile?apikey=").concat(encodeURIComponent(window.wpParselySiteId), "&uuid=").concat(encodeURIComponent(e), "&url=").concat(encodeURIComponent(window.location.href)), [2, fetch(t)]) : [2]
                    }))
                }, new((i = void 0) || (i = Promise))((function(n, o) {
                    function r(n) {
                        try {
                            u(a.next(n))
                        } catch (n) {
                    ...
                    function u(o) {
                        var e;
                        o.done ? n(o.value) : (e = o.value, e instanceof i ? e : new i((function(n) {
                            n(e)
                        }))).then(r, l)
                    }
